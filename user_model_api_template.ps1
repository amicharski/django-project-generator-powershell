...
{% endblock sidebar %}
'@ | Out-File -FilePath .\users\templates\sidebar.html -Encoding utf8
...
class UserLogout(views.LogoutView):
    pass
'@ | Out-File .\users\views.py -Encoding utf8

New-Item 'static' -ItemType Directory -ea 0

@'
/*body {*/
/*    color: red;*/
/*}*/
'@ | Out-File .\static\styles.css -Encoding utf8